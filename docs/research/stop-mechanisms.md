...
| Path | Where | Status |
|---|---|---|
| Tap the red stop button | `src/swift_app/WatchApp/UI/RecordScreen.swift:50` | Shipping |
...
static "Your Agents" label; change what the intent does. `StartRecordingIntent`
...
`src/swift_app/WatchApp/Completion/Haptics.swift`]** — which is right, and matters much more once stopping
